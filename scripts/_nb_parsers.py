"""
_nb_parsers.py — NB PDF 各格式解析器（Format A ~ N）+ parse_pdf 分派 + 信心分數。

由 process_nb.py 匯入；新增格式時於 _nb_detect.detect_format 加判斷、
在本檔新增 parse_format_X 並於 parse_pdf() 加分派。
"""
...
from _nb_detect import detect_format
